														...
														<div class="banner-wrapper banners">
															<div class="banner-image">
																<a href="shop-grid-left.html">
																	<img src="<?= urlOf('assets/media/banner/about-us-1.jpg') ?>" alt="Banner Image">
																</a>
															</div>
														</div>
													</div>
														...
														<div class="banners">
															<div class="row">
																<div class="col-md-6">
																	<div class="banner-image">
																		<a href="shop-grid-left.html">
																			<img src="<?= urlOf('assets/media/banner/about-us-2.jpg') ?>" alt="Banner Image">
																		</a>
																	</div>
																</div>
																	...
																	<div class="banner-wrapper-infor">
																		<div class="info">
																			<div class="content">
																				...
																				<a class="link-title" href="<?= urlOf('shop.php') ?>">
																				...
																				<a class="button button-outline" href="<?= urlOf('shop.php') ?>">SHOP NOW</a>
																			</div>
																		</div>
																	</div>
																</div>
														...
														<div class="banners">
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="banner-image">
																		<a href="shop-grid-left.html">
																			<img src="<?= urlOf('assets/media/banner/about-us-3.jpg') ?>" alt="Banner Image">
																		</a>
																	</div>
																</div>
															</div>
													...
													<div class="slick-sliders" data-slidestoscroll="true" data-nav="1" data-dots="0" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1">
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	<div class="thumbnail">
																		<img width="62" height="62" src="<?= urlOf('assets/media/testimonial/1.jpg') ?>" alt="">							
																	</div>
														...
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	<div class="thumbnail">
																		<img width="62" height="62" src="<?= urlOf('assets/media/testimonial/2.jpg') ?>" alt="">							
																	</div>
																	<div class="testimonial-info">
														...
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	<div class="thumbnail">
																		<img width="62" height="62" src="<?= urlOf('assets/media/testimonial/3.jpg') ?>" alt="">							
																	</div>
																	<div class="testimonial-info">
													...
													<div class="slick-sliders" data-nav="0" data-columns4="2" data-columns3="3" data-columns2="4" data-columns1="4" data-columns1440="5" data-columns="5">
														<div class="item slick-slide">
															<div class="item-image">
																<a href="#"> 
																	<img width="450" height="450" src="<?= urlOf('assets/media/brand/1.jpg') ?>" alt="Brand 1">
																</a>
															</div>
														</div>
														<div class="item slick-slide">
															<div class="item-image">
																<a href="#"> 
																	<img width="450" height="450" src="<?= urlOf('assets/media/brand/2.jpg') ?>" alt="Brand 2">
																</a>
															</div>
														</div>
														<div class="item slick-slide">
															<div class="item-image">
																<a href="#"> 
																	<img width="450" height="450" src="<?= urlOf('assets/media/brand/3.jpg') ?>" alt="Brand 3">
																</a>
															</div>
														</div>
														<div class="item slick-slide">
															<div class="item-image">
																<a href="#"> 
																	<img width="450" height="450" src="<?= urlOf('assets/media/brand/4.jpg') ?>" alt="Brand 4">
																</a>
															</div>
														</div>
														<div class="item slick-slide">
															<div class="item-image">
																<a href="#"> 
																	<img width="450" height="450" src="<?= urlOf('assets/media/brand/5.jpg') ?>" alt="Brand 5">
																</a>
															</div>
														</div>
													</div>
